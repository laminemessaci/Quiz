            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                ...
                <AppBar
                    ...
                    title={<View style={{ height: 4, backgroundColor: '#FFFFFF20', width: width / 2, borderRadius: 5 }}>
                        <View style={{ height: 4, backgroundColor: '#FFFFFF', width: width / 6, borderRadius: 5 }}></View>
                    </View>}
                ...
                <TouchableOpacity onPress={() => navigation.navigate('QD4')} activeOpacity={10} 
                style={{ flex: 1, padding: 15, backgroundColor: Colors.secondary, marginHorizontal: 10, borderRadius: 20, marginBottom: 20 }}>
                    <ScrollView showsVerticalScrollIndicator={false} >
                        ...
                        <Text style={[style.m14, { color: Colors.disable, marginTop: 15 }]}>QUESTION 5 OF 10</Text>
                        <Text style={[style.subtitle, { color: Colors.txt, marginTop: 5 }]}>Who are three players share the record for most Premier League red cards (8)?</Text>

                        <View style={{ marginTop:15, height: 120, paddingHorizontal: 10, borderWidth: 1, borderColor: '#E5E9EF', borderRadius: 20, marginBottom:10}}>
                            <TextInput placeholder='Write your answer' placeholderTextColor={Colors.disable}
