            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                ...
                <AppBar
                    ...
                    title={<View style={{ height: 4, backgroundColor: '#FFFFFF20', width: width / 2, borderRadius: 5 }}>
                        <View style={{ height: 4, backgroundColor: '#FFFFFF', width: width / 5, borderRadius: 5 }}></View>
                    </View>}
                ...
                <TouchableOpacity onPress={() => navigation.navigate('QDD4')} activeOpacity={10}
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} >
                        ...
                        <Image source={require('../../../assets/image/s54.png')} resizeMode='stretch' style={{ height: 160, width: 160, alignSelf: 'center' }} />

                        <Text style={[style.r16, { color: Colors.disable,textAlign:'center',marginTop:-15 }]}>Hold to speak</Text>
