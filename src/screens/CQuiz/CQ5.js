        ...
        <SafeAreaView style={[style.area, { backgroundColor: Colors.primary, }]}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                ...
                <AppBar
                    ...
                    leading={<TouchableOpacity onPress={() => navigation.navigate('CQ4')}>
                ...
                <View style={{ padding: 15, backgroundColor: Colors.secondary, marginHorizontal: 10, borderRadius: 20, marginBottom: 100 }}>
                    <ScrollView showsVerticalScrollIndicator={false} >
                            ...
                            <ScrollView horizontal showsHorizontalScrollIndicator={false} >
                                <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                                    ...
                                    <View style={[style.icon, { height: 32, width: 32, backgroundColor: Colors.active, borderWidth: 0 }]}>
                                        <Text style={[style.r14, { color: Colors.secondary, marginLeft: -2 }]}>5</Text>
                                    </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15, justifyContent: 'space-between' }}>
                            ...
                            <View style={[style.box, { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 }]}>
                                <Text style={[style.m12, { color: Colors.txt, marginRight: 5, }]}>True or False</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20 }}>
                            <TouchableOpacity style={{ flex: 1, borderRadius: 20, alignItems: 'center', backgroundColor: '#C4D0FB', paddingVertical: 15 }}>
                                <Icons name='plus' size={24} color={Colors.primary} />
                                <Text style={[style.m14, { color: Colors.primary, marginTop: 7 }]}>Add true answer</Text>
                            </TouchableOpacity>
                            <View style={{ marginHorizontal: 10 }}></View>
                            <TouchableOpacity style={{ flex: 1, borderRadius: 20, alignItems: 'center', backgroundColor: '#EFEEFC', paddingVertical: 15 }}>
                                <Icons name='plus' size={24} color={Colors.primary} />
                                <Text style={[style.m14, { color: Colors.primary, marginTop: 7 }]}>Add false answer</Text>
                            </TouchableOpacity>
                        </View>

                        <TouchableOpacity onPress={() => navigation.navigate('CQ6')}
